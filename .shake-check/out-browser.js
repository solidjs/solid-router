import { createMemo, createContext, untrack, onCleanup, createComponent, createSignal, runWithOwner, getOwner, createRoot, createRenderEffect, useContext, flush, sharedConfig } from 'solid-js';
...
function createRouter(config) {
  ...
  function RouterComponent(props) {
    ...
    const integration = createIntegration(config.history || browserHistory());
    let context;
